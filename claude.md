...
- Variables: TS_BIND_IP, MQTT_HOST, MQTT_PORT, MQTT_USER, MQTT_PASSWORD, WS_PUBLISH_ALLOWLIST, INFLUXDB_URL, INFLUXDB_TOKEN, INFLUXDB_ORG, INFLUXDB_BUCKET, INFLUXDB_USER, INFLUXDB_PASSWORD, SENSOR_STALE_AFTER_SECONDS, EVENT_SENSOR_STALE_AFTER_SECONDS, TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID, CAMERA_ENABLED, CAMERA_GATEWAY_HOSTPORT
